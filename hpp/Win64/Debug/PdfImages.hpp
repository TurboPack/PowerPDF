...
// (DO NOT EDIT: machine generated header) 'PdfImages.pas' rev: 31.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EPdfInvalidImageFormat(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High) : System::Sysutils::Exception(Msg, Args, Args_High) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EPdfInvalidImageFormat(NativeUInt Ident, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EPdfInvalidImageFormat(System::PResStringRec ResStringRec, const System::TVarRec *Args, const int Args_High)/* overload */ : System::Sysutils::Exception(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EPdfInvalidImageFormat(const System::UnicodeString Msg, const System::TVarRec *Args, const int Args_High, int AHelpContext) : System::Sysutils::Exception(Msg, Args, Args_High, AHelpContext) { }
