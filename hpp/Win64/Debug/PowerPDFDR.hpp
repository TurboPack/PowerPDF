...
// (DO NOT EDIT: machine generated header) 'PowerPDFDR.dpk' rev: 32.00 (Windows)

#ifndef PowerpdfdrHPP
#define PowerpdfdrHPP
...
namespace Powerpdfdr
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Powerpdfdr */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_POWERPDFDR)
using namespace Powerpdfdr;
#endif
#pragma pack(pop)
#pragma option pop
